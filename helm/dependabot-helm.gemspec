...
Gem::Specification.new do |spec|
  ...
  spec.summary      = "Provides Dependabot support for Helm Charts"
  spec.description  = "Dependabot-Helm provides support for bumping Helm Chart versions via Dependabot. " \
